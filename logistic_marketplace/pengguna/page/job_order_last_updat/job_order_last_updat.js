...
MapLastUpdate = Class.extend({
	init: function(wrapper) {
		var me = this;
		$('<style>#map_wrapper {height: 400px;}#map_canvas {width: 100%;height: 100%;}</style><script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBrMjPyhsG0hq2m7e2ODQvvDT31O-eINGE&callback=initMap"></script><div id="map_wrapper"><div class="mapping" id="map_canvas"></div></div>').appendTo($(wrapper).find(".layout-main"))
