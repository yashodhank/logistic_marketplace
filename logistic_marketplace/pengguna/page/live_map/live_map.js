...
LiveMap = Class.extend({
	init: function(wrapper) {
		var me = this;
		$('<style>#map_wrapper {height: 500px;}#map_canvas {width: 100%;height:80%;}</style><script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCUG1BaoBIpZIap-nr9jSpJOsEjDOQIPXo&callback=initMap"></script><div id="map_wrapper"><div class="mapping" id="map_canvas"></div></div>').appendTo($(wrapper).find(".layout-main"))
